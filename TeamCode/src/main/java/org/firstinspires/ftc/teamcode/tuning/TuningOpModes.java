...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = HelloDrake.MecanumDrive.class;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(HelloDrake.MecanumDrive.class)) {
            dvf = hardwareMap -> {
                HelloDrake.MecanumDrive md = new HelloDrake.MecanumDrive(hardwareMap, new Pose2d(0, 0, 0));

                List<Encoder> leftEncs = new ArrayList<>(), rightEncs = new ArrayList<>();
                List<Encoder> parEncs = new ArrayList<>(), perpEncs = new ArrayList<>();
                if (md.localizer instanceof HelloDrake.MecanumDrive.DriveLocalizer) {
                    HelloDrake.MecanumDrive.DriveLocalizer dl = (HelloDrake.MecanumDrive.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        HelloDrake.MecanumDrive.PARAMS.inPerTick,
                        HelloDrake.MecanumDrive.PARAMS.maxWheelVel,
                        HelloDrake.MecanumDrive.PARAMS.minProfileAccel,
                        HelloDrake.MecanumDrive.PARAMS.maxProfileAccel,
                        ...
                        md.lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(HelloDrake.MecanumDrive.PARAMS.kS,
                                HelloDrake.MecanumDrive.PARAMS.kV / HelloDrake.MecanumDrive.PARAMS.inPerTick,
                                HelloDrake.MecanumDrive.PARAMS.kA / HelloDrake.MecanumDrive.PARAMS.inPerTick)
                );
            };
